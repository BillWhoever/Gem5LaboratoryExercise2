...
|Num.	| L1d size (KB) | L1d Assoc. |  L1i size (KB) | L1i Assoc. |  L2 size (KB) | L2 Assoc. | Cache Line Size | Cost(L1_Size,L2_Size) |  IPC/Cost Bzip2 | IPC/Cost Hmmer | IPC/Cost Libm | IPC/Cost Mcf | IPC/Cost Sjeng | IPC/Cost Average |
| ----- | ------------- | ---------- | -------------- | ---------- | ------------- | --------- | --------------- | --------------------- | --------------- | -------------- | ------------- | ------------ | -------------- |----------------- |
| **IdealEstimate** | 64 | 4 | 64 | 4 | 1024 | 4 | 256 | 4096 | 1.52E-04 | 2.07E-04 | 1.47E-04 | 2.21E-04 | 6.57E-05 | 1.59E-04 |
